      ...
      <Container as={Stack} maxW={"7xl"} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 5 }} spacing={8}>
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>ADORAMA in your language</Link>
          </Stack>
          <Stack align={"flex-start"}>
            ...
            <Link href={"#"}>ADORAMA for business</Link>
            <Link href={"#"}>ADORAMA for freelancers</Link>
            <Link href={"#"}>FAQ</Link>
        ...
        <HStack>
          <RouterLink to="/">
            <Image
              ...
              src="https://i.ibb.co/RS75TMv/Untitled-design.png"
              boxSize={"38px"}
            ></Image>
          </RouterLink>
          <Text
          ...
          >
            <RouterLink to="/">ADORAMA</RouterLink>
          </Text>
        </HStack>
        <Stack>
